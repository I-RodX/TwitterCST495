...
class APIManager: SessionManager {
    ...
    static let consumerKey = "2CUIRUvaOHqjWXu2INhRjvfMU"//"YOUR_COMSUMER_KEY"
    static let consumerSecret = "cWxa2zSifxvXeLPQ1ZM8IWKdNMFtyfJt9SSt3pOxzOrzpxEJDs"//"YOUR_SECRET_KEY"
